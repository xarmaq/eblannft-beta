...
3. В настройках плагина (по желанию) указать свой `server_url` и
   `plugin_key`. Дефолт — `http://127.0.0.1:8787`, отключи или
   замени на адрес своего VPS перед использованием.
